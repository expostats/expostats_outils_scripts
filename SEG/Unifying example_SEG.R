...
#
# V1.03    Dec2019 update for compatibility with 2018 update version of graphs
...
data.sample.formatted <-data.formatting.SEG(data.in=data.sample,oel=24, oel.mult = 1)
